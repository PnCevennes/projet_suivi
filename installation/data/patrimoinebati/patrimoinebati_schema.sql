...
(
  ...
  pb_desc_code_ref character varying(250),
  ...
  pb_des_mur_grosoeuvre integer,
  pb_des_mur_misenoeuvre integer,
  pb_des_mur_revetement integer,
  pb_des_toit integer,
  pb_des_toit_precision character varying(250),
  pb_des_couvrement integer,
  pb_des_baie integer,
  pb_des_baie_precision character varying(250),
