...
--
-- Name: SCHEMA chiro; Type: COMMENT; Schema: -; Owner: -
--

COMMENT ON SCHEMA chiro IS 'schema du module chiroptères';
...
--
-- Name: SCHEMA suivi; Type: COMMENT; Schema: -; Owner: -
--

COMMENT ON SCHEMA suivi IS 'module de base';
...
begin
	if(NEW.geom is not NULL) THEN
		NEW.ref_commune = array(select a.insee_com from ref_geographique.l_communes a where st_intersects(st_transform(NEW.geom, 2154), a.geom) order by a.insee_com);
	elsif(TG_TABLE_NAME = 'base_observation') THEN
		NEW.ref_commune = (select ref_commune from suivi.pr_base_site where id=NEW.fk_bs_id);
	END IF;
	return NEW;
end;
$$;
...
CREATE TABLE pr_site_infos (
    ...
    site_schema character varying(255) DEFAULT NULL::character varying,
    cis_menace_cmt text,
...
CREATE TABLE pr_visite_observationtaxon (
    id integer NOT NULL,
    fk_bv_id integer NOT NULL,
    cotx_initial character varying(250) DEFAULT NULL::character varying,
...
CREATE TABLE subpr_observationtaxon_biometrie (
    id integer DEFAULT nextval('subpr_observationtaxon_biometrie_id_seq'::regclass) NOT NULL,
...
--
-- Name: base_application; Type: TABLE; Schema: lexique; Owner: -; Tablespace: 
--

CREATE TABLE base_application (
    id integer NOT NULL,
    app_nom character varying(50) NOT NULL
);
...
--
-- Name: observateur; Type: TABLE; Schema: lexique; Owner: -; Tablespace: 
--
...
--
-- Name: biometrie_biom_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE biometrie_biom_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: observateur_obs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE observateur_obs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: observation_taxon_ot_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE observation_taxon_ot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: observation_taxon_rt_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE observation_taxon_rt_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: pnc_group_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE pnc_group_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: pnc_user_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE pnc_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: base_application_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: base_observateur_obs_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--

CREATE SEQUENCE base_observateur_obs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: base_site_site_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--

CREATE SEQUENCE base_site_site_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: biometrie_biom_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: observateur_obs_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: observation_obs_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: observation_taxon_ot_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: rel_site_app; Type: TABLE; Schema: suivi; Owner: -; Tablespace: 
--

CREATE TABLE rel_site_app (
    site_id integer NOT NULL,
...
--
-- Name: site_site_id_seq; Type: SEQUENCE; Schema: suivi; Owner: -
--
...
--
-- Name: chiro_biometrie_pkey; Type: CONSTRAINT; Schema: chiro; Owner: -; Tablespace: 
--

ALTER TABLE ONLY subpr_observationtaxon_biometrie
    ADD CONSTRAINT chiro_biometrie_pkey PRIMARY KEY (id);


--
-- Name: chiro_conditions_observ_pkey; Type: CONSTRAINT; Schema: chiro; Owner: -; Tablespace: 
--

ALTER TABLE ONLY pr_visite_conditions
    ADD CONSTRAINT chiro_conditions_observ_pkey PRIMARY KEY (id);


--
-- Name: chiro_infos_site_pkey; Type: CONSTRAINT; Schema: chiro; Owner: -; Tablespace: 
--

ALTER TABLE ONLY pr_site_infos
    ADD CONSTRAINT chiro_infos_site_pkey PRIMARY KEY (id);


--
-- Name: chiro_observation_taxon_pkey; Type: CONSTRAINT; Schema: chiro; Owner: -; Tablespace: 
--

ALTER TABLE ONLY pr_visite_observationtaxon
    ADD CONSTRAINT chiro_observation_taxon_pkey PRIMARY KEY (id);
...
--
-- Name: base_application_pkey; Type: CONSTRAINT; Schema: lexique; Owner: -; Tablespace: 
--

ALTER TABLE ONLY base_application
    ADD CONSTRAINT base_application_pkey PRIMARY KEY (id);


--
-- Name: observateur_pkey; Type: CONSTRAINT; Schema: lexique; Owner: -; Tablespace: 
--

ALTER TABLE ONLY observateur
    ADD CONSTRAINT observateur_pkey PRIMARY KEY (id);
...
--
-- Name: base_observation_pkey; Type: CONSTRAINT; Schema: suivi; Owner: -; Tablespace: 
--

ALTER TABLE ONLY pr_base_visite
    ADD CONSTRAINT base_observation_pkey PRIMARY KEY (id);


--
-- Name: base_site_pkey; Type: CONSTRAINT; Schema: suivi; Owner: -; Tablespace: 
--

ALTER TABLE ONLY pr_base_site
    ADD CONSTRAINT base_site_pkey PRIMARY KEY (id);
...
--
-- Name: rel_site_app_pkey; Type: CONSTRAINT; Schema: suivi; Owner: -; Tablespace: 
--

ALTER TABLE ONLY rel_site_app
    ADD CONSTRAINT rel_site_app_pkey PRIMARY KEY (site_id, app_id);
...
--
-- Name: idx_f2a799a37987212d; Type: INDEX; Schema: suivi; Owner: -; Tablespace: 
--

CREATE INDEX idx_f2a799a37987212d ON rel_site_app USING btree (app_id);


--
-- Name: idx_f2a799a3f6bd1646; Type: INDEX; Schema: suivi; Owner: -; Tablespace: 
--

CREATE INDEX idx_f2a799a3f6bd1646 ON rel_site_app USING btree (site_id);
...
--
-- Name: fk_291ed261ec9c5fd7; Type: FK CONSTRAINT; Schema: chiro; Owner: -
--

ALTER TABLE ONLY subpr_observationtaxon_biometrie
    ADD CONSTRAINT fk_291ed261ec9c5fd7 FOREIGN KEY (fk_cotx_id) REFERENCES pr_visite_observationtaxon(id);


--
-- Name: fk_49ec129cf6bd1646; Type: FK CONSTRAINT; Schema: chiro; Owner: -
--

ALTER TABLE ONLY pr_site_infos
    ADD CONSTRAINT fk_49ec129cf6bd1646 FOREIGN KEY (fk_bs_id) REFERENCES suivi.pr_base_site(id);


--
-- Name: fk_5e796d2c4b182b51; Type: FK CONSTRAINT; Schema: chiro; Owner: -
--

ALTER TABLE ONLY pr_visite_observationtaxon
    ADD CONSTRAINT fk_5e796d2c4b182b51 FOREIGN KEY (fk_bv_id) REFERENCES suivi.pr_base_visite(id);


--
-- Name: fk_95658e144b182b51; Type: FK CONSTRAINT; Schema: chiro; Owner: -
--

ALTER TABLE ONLY pr_visite_conditions
    ADD CONSTRAINT fk_95658e144b182b51 FOREIGN KEY (fk_bv_id) REFERENCES suivi.pr_base_visite(id);
...
--
-- Name: fk_f2a799a37987212d; Type: FK CONSTRAINT; Schema: suivi; Owner: -
--

ALTER TABLE ONLY rel_site_app
    ADD CONSTRAINT fk_f2a799a37987212d FOREIGN KEY (app_id) REFERENCES lexique.base_application(id);


--
-- Name: fk_f2a799a3f6bd1646; Type: FK CONSTRAINT; Schema: suivi; Owner: -
--

ALTER TABLE ONLY rel_site_app
    ADD CONSTRAINT fk_f2a799a3f6bd1646 FOREIGN KEY (site_id) REFERENCES pr_base_site(id);
